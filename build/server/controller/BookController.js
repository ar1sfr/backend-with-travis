  ...
  (0, _createClass2["default"])(bookController, null, [{
    ...
    value: function () {
      ...
      _regenerator["default"].mark(function _callee3(req, res) {
        var alteredBook, id, _updateBook2;
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 8:
                _updateBook2 = _context3.sent;

                if (!_updateBook2) {
                  util.setError(404, "Cannot Find Book with ID: ".concat(id));
                } else {
                  util.setSuccess(200, 'Book Updated', _updateBook2);
                }
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 7:
                ...
                if (bookToDelete) {
                  ...
                  util.setError(404, "Book with ID ".concat(id, " Cannot Be Found"));
                }
